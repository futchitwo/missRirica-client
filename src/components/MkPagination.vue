...
const SECOND_FETCH_LIMIT = 99; //30;
const TOLERANCE = 16;
...
watch([$$(backed), $$(contentEl)], () => {
  if (!backed) {
    ...
    scrollRemove = (props.pagination.reversed ? onScrollBottom : onScrollTop)(
      contentEl,
      executeQueue,
      TOLERANCE
    );
    ...
    .then(
      (res) => {
        ...
        const reverseConcat = (_res) => {
          const oldHeight = scrollableElement
            ? scrollableElement.scrollHeight
            : getBodyScrollHeight();
          const oldScroll = scrollableElement
